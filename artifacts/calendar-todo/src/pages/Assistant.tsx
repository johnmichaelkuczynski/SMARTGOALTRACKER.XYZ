  ...
  return (
    <div className="space-y-8">
      ...
      <div className="rounded-xl border border-card-border bg-card flex flex-col">
        ...
        <form onSubmit={submit} className="border-t border-card-border p-3 flex items-end gap-2">
          <textarea
            value={input}
            ...
            className="flex-1 resize-y min-h-[5rem] max-h-64 bg-transparent px-3 py-2 text-sm leading-relaxed outline-none placeholder:text-muted-foreground"
          />
          <ImageOcrButton
